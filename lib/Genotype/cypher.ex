...
def create_node(%Sensor{name: name, function_name: function_name, output_vector_length: output_vector_length}, graph_name) do
  "CREATE (#{name}:Sensor {function_name: '#{function_name}', output_vector_length: #{output_vector_length}, #{graph_name}: true})"
end

def create_node(%Actuator{name: name, function_name: function_name, accumulated_actuation_vector_length: accumulated_actuation_vector_length}, graph_name) do
  "CREATE (#{name}:Actuator {function_name: '#{function_name}', accumulated_actuation_vector_length: #{accumulated_actuation_vector_length}, #{graph_name}: true})"
end
